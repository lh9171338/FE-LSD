...
class HourglassNet(nn.Module):
    def __init__(self, res_block, modulation_block, fusion_block, head_block, inplanes, num_feats, depth, num_stacks, num_blocks, num_classes):
        super().__init__()
